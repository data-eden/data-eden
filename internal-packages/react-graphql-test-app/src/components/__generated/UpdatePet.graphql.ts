...
export const UpdatePetDocument = {"__meta__":{"queryId":"af5c6749a82a0b93e9bce39adf9627e4fb5fd249da1010f72650417b155a5f65","$DEBUG":{"contents":"mutation UpdatePet($input: UpdatePetInput!, $petId: ID!) { updatePet(petId: $petId, input: $input) { __typename id name } }"}}} as unknown as DocumentNode<UpdatePetMutation, UpdatePetMutationVariables>;