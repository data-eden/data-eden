...
export const UpdateCarDocument = {"__meta__":{"queryId":"38a98bbd5e7b6463f8dda2de92b3b99c531ca7d53af036685dbc366e12ffc6da","$DEBUG":{"contents":"mutation UpdateCar($carId: ID!, $input: CarInput!) { updateCar(carId: $carId, input: $input) { __typename id make model } }"}}} as unknown as DocumentNode<UpdateCarMutation, UpdateCarMutationVariables>;